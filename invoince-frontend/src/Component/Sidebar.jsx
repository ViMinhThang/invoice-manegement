...
const Sidebar = ({ children }) => {
  ...
  const menuItems = [
    { name: 'Don Hang', icon: <LayoutDashboard size={20} />, path: '/invoices' },
    { name: 'Record Bill', icon: <FileText size={20} />, path: '/record-bill' },
    { name: 'Hoa Don Thanh Toan', icon: <CreditCard size={20} />, path: '/payments' },
  ]
